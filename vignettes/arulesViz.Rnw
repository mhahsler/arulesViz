...
with further control arguments to customize the plot. Using \code{engine},
...
Figure~\ref{fig:matrix_col1} %and \ref{fig:matrix_col2} show plots 
shows a plot with two
