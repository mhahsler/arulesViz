...
#' @seealso \code{\link[scatterplot3d]{scatterplot3d}} in \pkg{scatterplot3d},
#' \code{\link[igraph]{plot.igraph}} and \code{\link[igraph]{tkplot}} in
#' \pkg{igraph}, \code{\link[seriation]{seriate}} in \pkg{seriation}
...
#' Hierarchical Groups. \emph{Journal of Business Economics,} 87(3):17-335.
